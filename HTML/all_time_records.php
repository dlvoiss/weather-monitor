...
<p>Starting From December 2022</p>
...
$sql = "SELECT id, month, mintempfts, mintempf, maxtempfts, maxtempf, minhumts, minhum, maxhumts, maxhum, lowmBts, lowmB, highmBts, highmB FROM alltimedata";
...
<?php
# Find maximum temperature from alltimedata across all 12 months
$sql = "SELECT max(maxtempf) FROM alltimedata";
$statement = $pdo->query($sql);
$row = $statement->fetch();
$maxtemp = $row['max(maxtempf)'];
#echo "<p>Maximum Temperature: " . $maxtemp . "</p>";

$sql = "SELECT month,maxtempfts,maxtempf FROM alltimedata where maxtempf=" . $maxtemp;
#echo $sql;
$statement = $pdo->query($sql);
$row = $statement->fetch();
...
# Find minimum temperature from alltimedata across all 12 months
$sql = "SELECT min(mintempf) FROM alltimedata";
$statement = $pdo->query($sql);
$row = $statement->fetch();
$mintemp = $row['min(mintempf)'];
#echo "<p>Minimum Temperature: " . $mintemp . "</p>";

$sql = "SELECT month,mintempfts,mintempf FROM alltimedata where mintempf=" . $mintemp;
$statement = $pdo->query($sql);
$row = $statement->fetch();
...
# Find maximum humidity from alltimedata across all 12 months
$sql = "SELECT max(maxhum) FROM alltimedata";
$statement = $pdo->query($sql);
$row = $statement->fetch();
$maxhum = $row['max(maxhum)'];
#echo "<p>Maximum Temperature: " . $maxhum . "</p>";

$sql = "SELECT month,maxhumts,maxhum FROM alltimedata where maxhum=" . $maxhum;
#echo $sql;
$statement = $pdo->query($sql);
$row = $statement->fetch();
...
# Find minimum humidity from alltimedata across all 12 months
$sql = "SELECT min(minhum) FROM alltimedata";
$statement = $pdo->query($sql);
$row = $statement->fetch();
$minhum = $row['min(minhum)'];
#echo "<p>Minimum Temperature: " . $minhum . "</p>";

$sql = "SELECT month,minhumts,minhum FROM alltimedata where minhum=" . $minhum;
$statement = $pdo->query($sql);
$row = $statement->fetch();
$monHumMin = $row['month'];
$HumMin = $row['minhum'];
...
# Find maximum pressure from alltimedata across all 12 months
$sql = "SELECT max(highmB) FROM alltimedata";
$statement = $pdo->query($sql);
$row = $statement->fetch();
$maxmB = $row['max(highmB)'];
#echo "<p>Maximum Temperature: " . $maxmB . "</p>";

$sql = "SELECT month,highmBts,highmB FROM alltimedata where highmB=" . $maxmB;
#echo $sql;
$statement = $pdo->query($sql);
$row = $statement->fetch();
...
# Find minimum pressure from alltimedata across all 12 months
$sql = "SELECT min(lowmB) FROM alltimedata";
$statement = $pdo->query($sql);
$row = $statement->fetch();
$minmB = $row['min(lowmB)'];
#echo "<p>Minimum Temperature: " . $minmB . "</p>";

$sql = "SELECT month,lowmBts,lowmB FROM alltimedata where lowmB=" . $minmB;
$statement = $pdo->query($sql);
$row = $statement->fetch();
$monMbMin = $row['month'];
$MbMin = $row['lowmB'];
